...
char *argv2[] = {
		...
		"-jsgf", "/home/dbarbera/Data/climb/forced_align_000_climb1_colin_fixed_trimmed.wav.jsgf", "-pl_window", "0", "-beam", "1e-10000", "-lponlybeam", "1e-10000", "-pbeam", "1e-10000", "-vad_startspeech", "8", "-alpha", "0.97", "-pip", "1", "-bestpath", "no", "-lpbeam", "1e-10000", "-maxhmmpf", "-1",
...
const char* jsgf_filename_path2 = "/home/dbarbera/Data/climb/forced_align_000_climb1_colin_fixed_trimmed.wav.jsgf";
const char* audio_filename_path2 = "/home/dbarbera/Data/climb/climb1_colin_fixed_trimmed.wav";
...
void mock_ps_call(){
    ...
    //Setup:
    const char* jsgf_filename_path = jsgf_filename_path2;
    const char *audio_filename_path = audio_filename_path2;
    int argc_= argc2;
    //auto argv_ = argv2;
    ...
    //Call:
    ps_call(jsgf_buffer, jsgf_buffer_size, wav_data, wav_data_size, argc_, argv2, result, rsize);
